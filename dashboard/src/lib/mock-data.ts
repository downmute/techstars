...
export const alerts: Alert[] = [
	{
		...
		title: "PPD Risk — Mood declining 4 consecutive days",
		description: "Both declining for 5+ days. Highest priority flag triggered.",
		timestamp: "Today, 7:15 AM",
		whyFlagged:
			"Mood score ≤ 2/5 for 4 consecutive days (Mar 26–29). Sleep quality declining simultaneously. Recovery score dropped from 62 to 38 in one week.",
		differential:
			"Possible postpartum depression. Sleep deprivation may be masking as depression. Rule out postpartum anxiety (anxiety scores elevated at 7/10).",
		suggestedAction:
			"Schedule 15-min phone check-in. Consider EPDS screening at next visit. Review sleep hygiene and explore support system changes.",
	},
	{
		id: "a2",
		severity: "high",
		patientName: "Patient 9",
		title: "Sleep + mood co-decline — Patient 9",
		description: "Both declining for 5+ days. Highest priority flag triggered.",
	...
	},
	{
		...
		severity: "medium",
		patientName: "Patient 3",
		title: "Sleep decline pattern — Patient 3",
		description:
			"Sleep quality dropping for 5+ consecutive days alongside mood decline.",
		timestamp: "Mar 26",
	},
	{
		id: "a4",
		...
		title: "Voice discrepancy detected — Patient 5",
		description: "Reported mood 4/5 but speaking rate 40% below baseline.",
		timestamp: "Mar 25",
	},
	{
		id: "a5",
		...
		title: "Missed check-in — Patient 18",
		description: "No check-in for 3 consecutive days. Last active Mar 24.",
		timestamp: "Mar 27",
	},
];
