...
import { OrbColors, ORB_SIZE } from '@/constants/vela-colors';
    ...
    <GestureDetector gesture={composedGesture}>
      <View style={styles.touchTarget}>
        ...
        <Animated.View style={[styles.orbContainer, outerContainerStyle]}>
          ...
          <Animated.View style={[orbLayerStyle, styles.orbLayer, prevLayerStyle]} />

          {/* Incoming color layer (fades in on state change) */}
          <Animated.View style={[orbLayerStyle, styles.orbLayer, currLayerStyle]} />
