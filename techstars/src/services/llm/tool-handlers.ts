import { getMockEvents } from '@/services/calendar/calendar-mock';
import { exaSearch } from '@/services/search/exa-client';
import { saveMemory } from '@/services/memory/memory-store';
import type { MemoryCategory, ImportanceScore } from '@/services/memory/memory-types';
...
export async function executeToolCall(
  ...
  switch (name) {
    case 'calendar_get_events': {
      ...
      const events = getMockEvents(hoursAhead);
